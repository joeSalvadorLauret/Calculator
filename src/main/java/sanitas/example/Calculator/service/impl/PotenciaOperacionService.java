...
@Service
public class PotenciaOperacionService extends OperacionBaseService {
	
	private static String OPNAME = "potencia";
	
	public PotenciaOperacionService() {
		super(OPNAME);
	}
	...
	public String performOperation(String operando1, String operando2) {
		...
		return op1.pow(op2.intValue()).setScale(APIConstants.BIG_DECIMAL_SCALE, RoundingMode.CEILING).toString();
	}
